USE [Traces]
GO
/****** Object:  StoredProcedure [dbo].[stpLimpa_Cache_Consulta_Causando]    Script Date: 10/06/2021 15:11:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE   PROCEDURE [dbo].[stpLimpa_Cache_Consulta_Causando]
AS
/*
...
BEGIN
	...
	or text LIKE N'CREATE PROCEDURE %PR_SELECT_CUSTOMERLIMIT]%';
